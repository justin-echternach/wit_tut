    ...
    pub mod adder {
        ...
        pub mod add {
            ...
            pub fn add(a: u32, b: u32) -> u32 {
                unsafe {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "tut:adder/add@0.1.0")]
                    extern "C" {
                        #[link_name = "add"]
    ...
    pub mod tut {
        ...
        pub mod calculator {
            ...
            pub mod calculate {
                ...
                impl ::core::fmt::Debug for Op {
                    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                        match self {
                            ...
                            Op::Mult => f.debug_tuple("Op::Mult").finish(),
                        }
                    }
                }
                ...
                macro_rules! __export_tut_calculator_calculate_0_1_0_cabi{
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

          #[export_name = "tut:calculator/calculate@0.1.0#eval-expression"]
          unsafe extern "C" fn export_eval_expression(arg0: i32,arg1: i32,arg2: i32,) -> i32 {
            $($path_to_types)*::_export_eval_expression_cabi::<$ty>(arg0, arg1, arg2)
                ...
                #[doc(hidden)]
                pub(crate) use __export_tut_calculator_calculate_0_1_0_cabi;
            }
        }
    }
}
...
macro_rules! __export_calculator_impl {
  ...
  $($path_to_types_root)*::exports::tut::calculator::calculate::__export_tut_calculator_calculate_0_1_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::tut::calculator::calculate);
  )
}
#[doc(inline)]
...
A\x04\x01B\x03\x01@\x02\x01ay\x01by\0y\x04\0\x03add\x01\0\x04\0\x04mult\x01\0\x03\
\x01\x13tut:adder/add@0.1.0\x05\0\x01B\x04\x01m\x02\x03add\x04mult\x04\0\x02op\x03\
\0\0\x01@\x03\x02op\x01\x01xy\x01yy\0y\x04\0\x0feval-expression\x01\x02\x04\x01\x1e\
tut:calculator/calculate@0.1.0\x05\x01\x04\x01\x1ftut:calculator/calculator@0.1.\
