    ...
    pub mod tut {
        ...
        pub mod web {
            ...
            pub mod iweb {
                ...
                pub unsafe fn _export_make_get_request_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                ) -> *mut u8 {
                    #[cfg(target_arch = "wasm32")]
                    ...
                    let result1 = T::make_get_request(_rt::string_lift(bytes0));
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_make_get_request<T: Guest>(arg0: *mut u8) {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_make_post_request_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                    arg2: *mut u8,
                    arg3: usize,
                    ...
                    let result2 =
                        T::make_post_request(_rt::string_lift(bytes0), _rt::string_lift(bytes1));
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_make_post_request<T: Guest>(arg0: *mut u8) {
                    let l0 = *arg0.add(0).cast::<*mut u8>();
                    let l1 = *arg0.add(4).cast::<usize>();
                    _rt::cabi_dealloc(l0, l1, 1);
                }
                pub trait Guest {
                    fn make_get_request(url: _rt::String) -> _rt::String;
                    fn make_post_request(url: _rt::String, body: _rt::String) -> _rt::String;
                }
                #[doc(hidden)]

                macro_rules! __export_tut_web_iweb_0_1_0_cabi{
      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

        #[export_name = "tut:web/iweb@0.1.0#make-get-request"]
        unsafe extern "C" fn export_make_get_request(arg0: *mut u8,arg1: usize,) -> *mut u8 {
          $($path_to_types)*::_export_make_get_request_cabi::<$ty>(arg0, arg1)
        }
        #[export_name = "cabi_post_tut:web/iweb@0.1.0#make-get-request"]
        unsafe extern "C" fn _post_return_make_get_request(arg0: *mut u8,) {
          $($path_to_types)*::__post_return_make_get_request::<$ty>(arg0)
        }
        #[export_name = "tut:web/iweb@0.1.0#make-post-request"]
        unsafe extern "C" fn export_make_post_request(arg0: *mut u8,arg1: usize,arg2: *mut u8,arg3: usize,) -> *mut u8 {
          $($path_to_types)*::_export_make_post_request_cabi::<$ty>(arg0, arg1, arg2, arg3)
        }
        #[export_name = "cabi_post_tut:web/iweb@0.1.0#make-post-request"]
        unsafe extern "C" fn _post_return_make_post_request(arg0: *mut u8,) {
          $($path_to_types)*::__post_return_make_post_request::<$ty>(arg0)
        }
      };);
    }
                #[doc(hidden)]
                pub(crate) use __export_tut_web_iweb_0_1_0_cabi;
                #[repr(align(4))]
...
macro_rules! __export_web_impl {
  ...
  $($path_to_types_root)*::exports::tut::web::iweb::__export_tut_web_iweb_0_1_0_cabi!($ty with_types_in $($path_to_types_root)*::exports::tut::web::iweb);
  )
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.25.0:web:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 6512] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf61\x01A\x02\x01A\x17\
...
i:http/outgoing-handler@0.2.0\x05\x0e\x01B\x04\x01@\x01\x03urls\0s\x04\0\x10make\
-get-request\x01\0\x01@\x02\x03urls\x04bodys\0s\x04\0\x11make-post-request\x01\x01\
\x04\x01\x12tut:web/iweb@0.1.0\x05\x0f\x04\x01\x11tut:web/web@0.1.0\x04\0\x0b\x09\
\x01\0\x03web\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
